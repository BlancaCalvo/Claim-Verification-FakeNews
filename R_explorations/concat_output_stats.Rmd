...
knitr::opts_knit$set(root.dir = '~/Desktop/ClaimVer/Claim-Verification-FakeNews/')
...
#setwd("~/Desktop/ClaimVer/Claim-Verification-FakeNews/")
...
```{r ce2}
dev<- read.table("~/Desktop/ClaimVer/Claim-Verification-FakeNews/data/gear/N_gear-dev-set-0_001.tsv", sep="\t", header=FALSE, comment.char="#", na.strings=".", stringsAsFactors=FALSE, quote="", fill=TRUE)
...
```{r ce5}
bert_results<- read.csv("~/Desktop/ClaimVer/Claim-Verification-FakeNews/code/outputs/F-base-bert-2/dev-results.tsv", header = FALSE, sep='\t')
...
```{r ce6}
sembert_12_results<- read.csv("~/Desktop/ClaimVer/Claim-Verification-FakeNews/code/outputs/sembert_all_tags/dev-results.tsv", header = FALSE, sep='\t')
...
```{r ce10}
dream_mapping <- read.csv("~/Desktop/ClaimVer/Claim-Verification-FakeNews/code/outputs/sembert_dream/dev-results.tsv", header = FALSE, sep='\t')
...
```{r ce12}
tag_mapping<- read.csv("~/Desktop/ClaimVer/Claim-Verification-FakeNews/code/outputs/f_sembert-concat_True-agg_False-20batch_size-250seq_length-12n_aspect-tags1/dev-results.tsv", header = FALSE, sep='\t')
...
```{r ce12}
oie<- read.csv("~/Desktop/ClaimVer/Claim-Verification-FakeNews/code/outputs/sembert_oie/dev-results.tsv", header = FALSE, sep='\t')
...
```{r ce12}
oie<- read.csv("~/Desktop/ClaimVer/Claim-Verification-FakeNews/code/outputs/sembert_oie_tags1/dev-results.tsv", header = FALSE, sep='\t')
...
```{r ce16}
att_tag<- read.csv("~/Desktop/ClaimVer/Claim-Verification-FakeNews/code/outputs/sembert_att_tags1/dev-results.tsv", header = FALSE, sep='\t')
...
```{r ce6}
gold_b<- read.csv("~/Desktop/ClaimVer/Claim-Verification-FakeNews/code/outputs/gold_bert_base/dev-results.tsv", header = FALSE, sep='\t')
...
```{r ce6}
gold<- read.csv("~/Desktop/ClaimVer/Claim-Verification-FakeNews/code/outputs/gold_sembert_tags1/dev-results.tsv", header = FALSE, sep='\t')
...
```{r ce6}
gold<- read.csv("~/Desktop/ClaimVer/Claim-Verification-FakeNews/code/outputs/gold_little/dev-results3.tsv", header = FALSE, sep='\t')
...
```{r ce6}
gold<- read.csv("~/Desktop/ClaimVer/Claim-Verification-FakeNews/code/outputs/gold_little/dev-results4.tsv", header = FALSE, sep='\t')
...
json_data <- fromJSON(paste(readLines("~/Desktop/ClaimVer/Claim-Verification-FakeNews/data/gear/dev_srl_all.json"), collapse=""))
...
gold_dev<- read.table("~/Desktop/ClaimVer/Claim-Verification-FakeNews/data/gear/gold_evidence_dev.tsv", sep="\t", header=FALSE, comment.char="#", na.strings=".", stringsAsFactors=FALSE, quote="", fill=TRUE)
```
...
lines <- readLines("~/Desktop/ClaimVer/Claim-Verification-FakeNews/data/retrieved/dev.ensembles.s10.jsonl")
...
x <- scan("~/Desktop/ClaimVer/Claim-Verification-FakeNews/annotations/multi-hop-index.txt", what="", sep="\n")
