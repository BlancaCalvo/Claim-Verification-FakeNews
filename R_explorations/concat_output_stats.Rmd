...
```{r ce5}
bert_results<- read.csv("C:/Users/bcalvo/Box/bcalvo/Claim-Verification-FakeNews/experiment-5/outputs/bert_base/F-dev-results.tsv", header = FALSE, sep='\t')
...
```{r ce6}
sembert_12_results<- read.csv("C:/Users/bcalvo/Box/bcalvo/Claim-Verification-FakeNews/experiment-5/outputs/sembert_base/F-dev-results.tsv", header = FALSE, sep='\t')
...
```{r ce10}
dream_mapping <- read.csv("C:/Users/bcalvo/Box/bcalvo/Claim-Verification-FakeNews/experiment-5/outputs/mapping/F-dream-dev-results.tsv", header = FALSE, sep='\t')
...
```{r ce12}
tag_mapping<- read.csv("C:/Users/bcalvo/Box/bcalvo/Claim-Verification-FakeNews/experiment-5/outputs/mapping/F-tags1-dev-results.tsv", header = FALSE, sep='\t')
...
### Comparison base_bert and sembert_tags1
...
```{r ce12}
oie<- read.csv("C:/Users/bcalvo/Box/bcalvo/Claim-Verification-FakeNews/experiment-5/outputs/oie/dev-results-tags.tsv", header = FALSE, sep='\t')
...
```{r ce16}
att_tag<- read.csv("C:/Users/bcalvo/Box/bcalvo/Claim-Verification-FakeNews/experiment-5/outputs/agg_tags1/f-dev-results.tsv", header = FALSE, sep='\t')
...
```{r ce6}
gold_b<- read.csv("C:/Users/bcalvo/Box/bcalvo/Claim-Verification-FakeNews/experiment-5/outputs/gold/bert-results.tsv", header = FALSE, sep='\t')
...
```{r ce6}
gold<- read.csv("C:/Users/bcalvo/Box/bcalvo/Claim-Verification-FakeNews/experiment-5/outputs/gold/dev-results.tsv", header = FALSE, sep='\t')
