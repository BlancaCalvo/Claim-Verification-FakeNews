...
all = merge(bert_comparison, sembert_12_results, by="V5")
...
all_dev = merge(head(dev, -1), differing_improve, by.x=("V1"), by.y=("V5"))

inspect <- all_dev%>%
  select(V1, V2, output.x, output.y, V3, V4, V5)
