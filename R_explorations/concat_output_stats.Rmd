...
```{r import_results}
mapping<- read.csv("C:/Users/bcalvo/Box/bcalvo/Claim-Verification-FakeNews/experiment-5/outputs/mapping/dev-results.tsv", header = FALSE, sep='\t')
...
#  select(ID, output.sembert, V3.gold, V5.gold, V2.gold, V4.retrieved, V5.retrieved, V6.retrieved, V7, V8)
...
go <- differing%>%
  ...
  filter(output.sembert==2)%>%
  select(V1, output.bert, output.sembert, V3, V4,V5,V6, V7, V8)
...
json_data[[72]]$claim_srl

json_data[[72]]$evidence_srl
