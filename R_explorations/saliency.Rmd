...
```{r load_data_s}
lines <- readLines("C:/Users/bcalvo/Box/bcalvo/Claim-Verification-FakeNews/data/saliency/sembert/sembert/scores_sal_l2_1")
lines <- lapply(lines, fromJSON)
lines <- lapply(lines, unlist)
metric11 <- bind_rows(lines)
lines <- readLines("C:/Users/bcalvo/Box/bcalvo/Claim-Verification-FakeNews/data/saliency/sembert/sembert/scores_guided_l2_1")
lines <- lapply(lines, fromJSON)
lines <- lapply(lines, unlist)
metric21 <- bind_rows(lines)
lines <- readLines("C:/Users/bcalvo/Box/bcalvo/Claim-Verification-FakeNews/data/saliency/sembert/sembert/scores_inputx_l2_1")
lines <- lapply(lines, fromJSON)
lines <- lapply(lines, unlist)
