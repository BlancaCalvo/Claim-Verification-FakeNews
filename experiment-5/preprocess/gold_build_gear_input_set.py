...
if __name__ == '__main__':
    ...
    build_with_threshold('data/gear/gold_bert-nli-train-retrieve-set.tsv',
                         'data/gear/gold_gear-train-set-0_001.tsv', 0.001)
    ...
    build_with_threshold('data/gear/gold_bert-nli-dev-retrieve-set.tsv',
                         'data/gear/gold_gear-dev-set-0_001.tsv', 0.001)
