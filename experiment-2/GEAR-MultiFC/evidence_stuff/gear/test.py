...
dev_features, dev_claims = load_bert_features_claim_test('data/MultiFC/evidence_dev_data-features.tsv', args.evi_num)
test_features, test_claims = load_bert_features_claim_test('data/MultiFC/evidence_train_data-features.tsv', args.evi_num)
...
for seed in seeds:
    base_dir = 'experiment-2/GEAR-MultiFC/outputs/gear-%devi-%dlayer-%s-%dseed-001-evidence/' % (args.evi_num, args.layer, args.pool, seed)
