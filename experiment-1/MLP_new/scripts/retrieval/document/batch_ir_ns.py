...
if __name__ == "__main__":
    ...
    with open("data/retrieved-ukp/{0}.ensembles.s10.jsonl".format(split),"r") as f:
        with open("experiment-1/MLP_new/sampled_data/{0}.ns.pages.p{1}.jsonl".format(split,k),"w+") as f2:
